class Game {
        ...
        displayRanks(){
          ...
          image(gold_img,0,-100, 200, 250);
          image(silver_img,displayWidth/4,displayHeight/9-100, 200, 250);
          image(bronze_img,displayWidth/-4,displayHeight/9-100, 200, 250);

          for(var plr in allPlayers){
            if(allPlayers[plr].place === 1){
              text("1st:"+ allPlayers[plr].name, 0, 85);
            }else if(allPlayers[plr].place===2){
               text("2nd:"+allPlayers[plr].name,displayWidth/4,displayHeight/9+80);
            }else if(allPlayers[plr].place ===3){
              text("3rd:"+allPlayers[plr].name, displayWidth/-4, displayHeight/9+80)
            }else{
              textSize(20);
              text("Honorable Mention:"+allPlayers[plr].name, 300, 225);
            }
